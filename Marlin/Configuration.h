 ...
 *   - Enable MIXING_IN_G1 for M165 and mixing in G1 (from Pia Taubert's reference implementation).
 */
...
#define PSU_NAME "Power Supply"
  ...
  #define AUTO_POWER_CONTROL      // Enable automatic control of the PS_ON pin
    ...
    #define POWER_OFF_DELAY 30    // (s) Delay for the shutoff of the PSU; for example used to let a cooling-fan run after print is finished
  #endif
#endif
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 20, 120, 120 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 600, 600, 100, 1000, 1000 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -42, -36, -2.65 }
 ...
 * 
 * If you want to mount the SD Card when it´s inserted to the slot, uncomment the following line.
 * 
 */
